...
export class addEntityChanges1676559603419 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "sorteo" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "abreviatura" character varying NOT NULL, "img_url" character varying, "descripcion" character varying NOT NULL, "hora" TIME NOT NULL, "activo" boolean NOT NULL DEFAULT true, "id_juego" integer, "id_loteria" integer, CONSTRAINT "PK_bceabbfbd982f671b4bce79960b" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "so_a_bu" ("id" SERIAL NOT NULL, "activo" boolean NOT NULL DEFAULT true, "buscando" boolean NOT NULL DEFAULT false, CONSTRAINT "PK_25912bebcc77fa395fc9d2e6f9f" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "xpath" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "descripcion" character varying NOT NULL, "activo" boolean NOT NULL DEFAULT true, "xpath_digitos" character varying array NOT NULL, "xpath_urls_by_digitos" character varying array NOT NULL, "xpath_fecha_by_digito" character varying array NOT NULL, CONSTRAINT "PK_c75a940d9064883c634bb2f8b21" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
