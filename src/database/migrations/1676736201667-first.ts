...
export class first1676736201667 implements MigrationInterface {
  name = 'first1676736201667';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "juego" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "abreviatura" character varying NOT NULL, "descripcion" character varying NOT NULL, "posiciones" integer NOT NULL, "rango_minimo" integer NOT NULL, "rango_maximo" integer NOT NULL, "activo" boolean NOT NULL DEFAULT true, CONSTRAINT "PK_d0ac2f7932d13ee8976f473fe6f" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "resultados" ("id" SERIAL NOT NULL, "numeros_ganadores" integer array NOT NULL, "fecha" TIMESTAMP WITH TIME ZONE NOT NULL, "activo" boolean NOT NULL DEFAULT true, "create_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "update_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "id_sorteo" integer, CONSTRAINT "PK_b5c208f402f18d0ac82ae19b0d2" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "loteria" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "abreviatura" character varying NOT NULL, "img_url" character varying, "descripcion" character varying NOT NULL, "activo" boolean NOT NULL DEFAULT true, CONSTRAINT "UQ_c1c7c728666c54fa223f31aff55" UNIQUE ("name"), CONSTRAINT "UQ_10fe1610bd383608a3c01d20d63" UNIQUE ("abreviatura"), CONSTRAINT "PK_e8d2732119d5d0899bc94221024" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "xpath" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "descripcion" character varying NOT NULL, "activo" boolean NOT NULL DEFAULT true, "xpath_digitos" character varying array NOT NULL, "xpath_urls_by_digitos" character varying array NOT NULL, "xpath_fecha_by_digitos" character varying array NOT NULL, "id_sorteo_a_buscar" integer, CONSTRAINT "PK_c75a940d9064883c634bb2f8b21" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "so_a_bu" ("id" SERIAL NOT NULL, "activo" boolean NOT NULL DEFAULT true, "buscando" boolean NOT NULL DEFAULT false, "numeros_intentos" integer NOT NULL, "tiempo_de_espera_segundos" integer NOT NULL, "id_sorteo" integer, CONSTRAINT "REL_19f6e54e4522322884d0ace7a7" UNIQUE ("id_sorteo"), CONSTRAINT "PK_25912bebcc77fa395fc9d2e6f9f" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "sorteo" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "abreviatura" character varying NOT NULL, "img_url" character varying, "descripcion" character varying NOT NULL, "activo" boolean NOT NULL DEFAULT true, "id_juego" integer, "id_loteria" integer, CONSTRAINT "PK_bceabbfbd982f671b4bce79960b" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."dias_name_enum" AS ENUM('DOMINGO', 'LUNES', 'MARTES', 'MIERCOLES', 'JUEVES', 'VIERNES', 'SABADO')`,
    );
    await queryRunner.query(
      `CREATE TABLE "dias" ("id" SERIAL NOT NULL, "name" "public"."dias_name_enum" NOT NULL, CONSTRAINT "UQ_f0b62bd212476c096bd8276997b" UNIQUE ("name"), CONSTRAINT "PK_c3ec07a9d7a384961b1446b72f6" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "xpath" ADD CONSTRAINT "FK_dc0531dce457b0fd65743fcb64f" FOREIGN KEY ("id_sorteo_a_buscar") REFERENCES "so_a_bu"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "sorteo_dias" ADD CONSTRAINT "FK_03ff16940a7b6b996c68751dbb6" FOREIGN KEY ("id_dias") REFERENCES "dias"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "xpath" DROP CONSTRAINT "FK_dc0531dce457b0fd65743fcb64f"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(`DROP TYPE "public"."dias_name_enum"`);
